...
import { Send, Paperclip, Search, Phone, MoreVertical, CheckCheck, X } from "lucide-react";
...
export default function Chat() {
  ...
  const filteredConvos = conversations.filter((c) =>
    ...
    c.protocol.includes(searchTerm)
  );
          ...
          {loading ? (
            ...
            filteredConvos.map((c) => (
              <button
                ...
                className={cn(
                  "w-full flex items-start gap-3 p-3 text-left hover:bg-muted/50 transition-colors border-b",
                  selectedConvo?.id === c.id && "bg-muted"
                )}
              >
                <Avatar className="h-10 w-10 shrink-0">
                  <AvatarFallback className="bg-primary/10 text-primary text-xs">
                    {c.contact.name.substring(0, 2).toUpperCase()}
                  </AvatarFallback>
                </Avatar>
          ...
          <div className="flex items-center justify-between p-3 border-b bg-card">
            <div className="flex items-center gap-3">
              ...
              <Avatar className="h-9 w-9">
                <AvatarFallback className="bg-primary/10 text-primary text-xs">
                  {selectedConvo.contact.name.substring(0, 2).toUpperCase()}
                </AvatarFallback>
              </Avatar>
              <div>
            ...
            <div className="flex items-center gap-1">
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={closeConversation} title="Finalizar atendimento">
                ...
                <div
                  ...
                  className={cn(
                    ...
                    msg.sender_type === "agent"
                      ...
                      ? "mx-auto bg-muted text-muted-foreground text-center text-xs max-w-full"
                      : "bg-muted"
                  )}
                >
                  ...
                  <p className={cn(
                    "text-[10px] mt-1",
                    msg.sender_type === "agent" ? "text-primary-foreground/70 text-right" : "text-muted-foreground"
                  )}>
